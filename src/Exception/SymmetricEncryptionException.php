...
class SymmetricEncryptionException extends RuntimeException implements ExceptionInterface
{
     ...
     */
    public const ENVIRONMENT_IS_BROKEN = 5;

    /**
     * Wrong key or modified ciphertext
     */
    public const WRONG_KEY_OR_MODIFIED_CIPHERTEXT = 6;
     ...
     */
    public static function cryptoTypeError(TypeError $e): SymmetricEncryptionException
    {
     ...
     * @return SymmetricEncryptionException
     */
    public static function environmentIsBroken(EnvironmentIsBrokenException $e): SymmetricEncryptionException
    {
     ...
     * @return SymmetricEncryptionException
     */
    public static function wrongKeyOrModifiedCiphertext(WrongKeyOrModifiedCiphertextException $e): SymmetricEncryptionException
    {
